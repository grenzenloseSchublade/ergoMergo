...
//
// Aufruf:
//   node tools/release.mjs           nächste Version (v50 → v51)
//   node tools/release.mjs v52       explizite Version
...
const neu = process.argv[2] ?? `v${Number(sw.v.slice(1)) + 1}`;
if (!/^v\d+$/.test(neu)) { console.error(`ungültige Version: ${neu} (erwartet z. B. v51)`); process.exit(1); }
